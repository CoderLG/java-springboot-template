...
public class ConfController {
    ...
    @ApiOperation(value = "获取配置文件server.port")
    @GetMapping("/getConfig")
    public void getConfig(){
        System.out.println(baseConfig.getEnvProperty("server.port"));
    }
    ...
    public void setUsersss(String name,String otherName) {
        ...
        System.out.println("@Value用在方法上，此方法会在初始化的时候 被执行");
